    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="{{url('voter/login')}}"><span>login</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
          ...
          <li ><a href="{{url('voter/login')}}"><span>login</span> <i class="bi bi-chevron-down"></i></a>

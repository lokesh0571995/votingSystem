                                ...
                                @foreach($nomineeList as $value)
                                    <tr>
                                        ...
                                        <td>
                                           @if($value->status==1)
                                                <div >
                                                <a href="{{url('admin/nominie/reject')}}/{{base64_encode($value->id)}}" class="btn btn-success">Approved</a>
                                                </div>
                                            @else
                                                <div >
                                                <a href="{{url('admin/nominie/approve')}}/{{base64_encode($value->id)}}"  class="btn btn-danger">Rejected</a>
                                                </div>
                                            @endif
                                        </td>
                                        <td>
